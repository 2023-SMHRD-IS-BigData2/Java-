...
<body>
	...
	<fieldset>
		...
		<form action="MEMBER_update" method="post">
			...
			소형<input type="radio" name="CAR_TYPE"value="<%=loginMember.getCAR_TYPE()%>">
			중형<input type="radio" name="CAR_TYPE"value="<%=loginMember.getCAR_TYPE()%>">
			대형<input type="radio" name="CAR_TYPE"value="<%=loginMember.getCAR_TYPE()%>">
			<br>
